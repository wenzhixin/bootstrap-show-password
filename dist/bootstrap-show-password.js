(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('core-js/modules/es.array.concat'), require('core-js/modules/es.array.find'), require('core-js/modules/es.array.join'), require('core-js/modules/es.parse-int'), require('core-js/modules/es.regexp.exec'), require('core-js/modules/es.string.replace'), require('jquery')) :
  typeof define === 'function' && define.amd ? define(['core-js/modules/es.array.concat', 'core-js/modules/es.array.find', 'core-js/modules/es.array.join', 'core-js/modules/es.parse-int', 'core-js/modules/es.regexp.exec', 'core-js/modules/es.string.replace', 'jquery'], factory) :
  (global = global || self, factory(null, null, null, null, null, null, global.jQuery));
}(this, function (es_array_concat, es_array_find, es_array_join, es_parseInt, es_regexp_exec, es_string_replace, $) { 'use strict';
